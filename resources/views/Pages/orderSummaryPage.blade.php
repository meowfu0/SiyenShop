                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center px-5">
                            <div class="col-2 m-0 p-0">
                                <p class="fw-bolder text-primary mb-0">Shop Name: <span class="fw-normal">CirCuits</span></p>
                                <p class="fw-bolder text-primary mb-0">No. of Items: <span class="fw-normal">2 item(s)</span></p>
                            </div>

                            <div class="mt-2">
                                <p class="fs-4">
                                    <span class="ms-1 fw-bolder col-6">Total Payment:</span>
                                    <span>₱ 600.00</span>
                                </p>  
                            </div>
