        ...
        <div class="row d-flex justify-content-center align-items-center h-100"> 
            <div class="col-11">
                <div class="d-flex justify-content-start align-items-center mb-2">
                    ...
                    <h1 class="ms-1 text-primary fs-7 fw-bold">Order Review</h1> 
                </div>   
                <!------- Sample data ------->                
                <div class="border rounded-3 border-primary table-responsive">
                    ...
                    <h1 class="ms-1 text-primary fs-7 fw-bold">Transactions</h1> 
                </div>   
                <!------- Sample data ------->                
                
                <div class="container p-3 border border-primary rounded-3" id="featured-3">
                <table class="table table-borderless mt-2 ">
                                        <thead class="table-headPage">
                                            <tr class="fw-bold fs-6">
                                            <th class="text-primary">GCash Receiver</th>
                                            <th></th>
                                            <th class="text-primary">GCash Sender</th> 
                                            </tr>
                                        </thead>
                                        <tbody class="noBorderPage">
