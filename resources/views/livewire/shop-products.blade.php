...
<div class="col-md-2 d-flex align-items-center px-3 justify-content-end ">
    ...
    <img class="img-thumbnail" src="{{ asset('images/Delete.svg') }}" alt="Delete" style="width: 35px; height: 35px;" data-bs-toggle="modal" data-bs-target="#deleteModal">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        ...
        <a href="{{ route('shop.products.add') }}" class="btn btn-primary- position-relative p-2 border rounded-2 fs-3">
