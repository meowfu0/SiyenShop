                    ...
                    <div class="card border border-primary p-4">
                        <div class="card-body">
                            <form>
                                ...
                                <p>Please ensure that you make a payment of <span class="fw-bolder text-primary">₱ 600.00</span> to <span class="fw-bolder text-primary">CirCUITS</span>, and remember to provide accurate information.</p>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#ModalProceedPayment" class="btn btn-primary">
                                        Confirm Payment
