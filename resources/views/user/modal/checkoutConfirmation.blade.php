<div class="modal fade" id="ModalConfirmed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer border-0 d-flex justify-content-center mb-2">
        ...
        <a href="{{ route('home') }}" class="btn btn-outline-primary btn-md" style="width:170px;">Return To Homepage</a>
