                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center px-5">
                            <div class="col-2 m-0 p-0 w-25">
                                <p class="fw-bolder text-primary mb-0">Shop Name: <span class="fw-normal fs-3">{{$item->shop_name}}</span></p>
                                <p class="fw-bolder text-primary mb-0">No. of Items: <span class="fw-normal fs-3">{{$item->total_items}} item(s)</span></p>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center p-0">
                    <img src="{{ asset('images/' . $item->proof_of_payment) }}" alt="Proof of Payment" class="img-fluid w-50">
                </div>
            </div>
        </div>
    </div>
