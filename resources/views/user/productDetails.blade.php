                        ...
                        <div class="mx-auto justify-content-start">
                                            ...
                                            @if ($product->variants->count() > 0)
                                                @foreach ($product->variants as $index => $variant)
                                                    <button type="button"
                                                        ...
                                                        onclick="document.getElementById('selectedSize').value = '{{$variant->id}}'">
                                                        {{ $variant->size }}
                                                    </button>
                                                @endforeach
                                            @else
                            ...
                            <div class="d-flex justify-content-between align-items-center w-100" style="margin-top: 5rem;">
                               ...
                               <form action="{{ route('productDetails.addToCart') }}" method="POST" id="addToCartForm">
                                ...
                                <input type="number" id="quantity" name="quantity" value="1" class="d-none">
                                <button type="submit" class="btn btn-secondary fw-medium d-flex align-items-center justify-content-center gap-2"
