                ...
                <div class="card">
                    ...
                    <div class="card-body clearfix">
                                ...
                                <div class="mx-auto justify-content-start">
                                    ...
                                    <div class="size-variation">
                                        ...
                                        <button type="button" class="btn btn-outline-primary fw-semibold"
                                            data-bs-toggle="button" aria-pressed="false" autocomplete="off">XS</button>
                                        <button type="button" class="btn btn-outline-primary fw-semibold"
                                            data-bs-toggle="button" aria-pressed="false" autocomplete="off">M</button>
                                        <button type="button" class="btn btn-outline-primary fw-semibold"
                                            data-bs-toggle="button" aria-pressed="false" autocomplete="off">L</button>
                                        <button type="button" class="btn btn-outline-primary fw-semibold"
                                            data-bs-toggle="button" aria-pressed="false" autocomplete="off">XL</button>
                                        <button type="button" class="btn btn-outline-primary fw-semibold"
                                            data-bs-toggle="button" aria-pressed="false" autocomplete="off">2XL</button>
                                    </div>
                        ...
                        <div class="row col-md-12 justify-content-center">
                            ...
                            <ul class="ml-5">
                                <li class="mb-2 ml-5">Lorem ipsum dolor sit amet consectetur. Integer ut sed praesent eget
                                    auctor donec egestas orci amet. Leo amet in auctor tellus egestasetia m nunc quis. Nibh
                                    tincidunt enim vitae scelerisque pellentesque. Urna fames bibendum fames nisl et</li>
                                <li class="mb-2 ml-5">Lorem ipsum dolor sit amet consectetur. Integer ut sed praesent eget
                                    auctor donec egestas orci amet. Leo amet in auctor tellus egestasetia m nunc quis</li>
                                <li class="mb-2 ml-5">Lorem ipsum dolor sit amet consectetur. Integer ut sed praesent eget
                                    auctor donec egestas orci amet. Leo amet in auctor </li>
                            </ul>
                        </div>
                        <div class="row col-md-12 justify-content-center">
                            <h2 class="fs-9 fw-semibold mt-0" style="color: #092C4C">Customer Reviews
                                <span class="fs-4"><a href="{{ url('customerReview') }}"
                            ...
                            <div class="ml-4 mt-4 d-flex flex-row comment-row"
                                ...
                                <div class="comment-text w-100">
                                    <p class="fs-4 mt-3">Juan Dela Cruz<span class="date fs-3 mr-3"
                                            style="float:right;">April 14, 2019</span></p>
                                    <p class="mt-0">Lorem Ipsum is simply dummy text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text ever since the
                                        1500s, when an unknown printer took a galley of type and scrambled it</p>
                                </div>
                            </div>
                            <div class="ml-4 mt-4 d-flex flex-row comment-row"
                                style="border: 1px solid #BDBDBD; border-radius: 8px;">
                ...
                <div class="row row-cols-2 row-cols-md-4 row-cols-xl-5 gap-5 justify-content-center">
                    <div class="block-7 pd">
                        ...
                        <div class="text-center p-4">
                            ...
                            <a href="{{ url('productDetails') }}" class="btn btn-primary d-block px-2 py-3">View
                                Details<span style="margin-left: 5px;">&#8599;</span></a>
                        </div>
                    </div>
                    ...
                    <div class="block-7"><img src="{{ asset('images/sample.jpg') }}" class="img-fluid"
                            style="width: 190px !important; height: 200px !important">
                        <div class="text-center p-4">
                            <div class="badge">CIRCUITS</div>
                            <span class="excerpt d-block">CirCUITS T-Shirt</span>
