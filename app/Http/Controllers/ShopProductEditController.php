...
class ShopProductEditController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $stocks = $validated['status_id'] !== 9 ? ($validated['stocks'] ?? 0) : 0;
        ...
        if (!empty($validated['variants'])) {
            ...
            foreach ($validated['variants'] as $variantData) {
                ...
                if ($validated['status_id'] == '9') {
                    $total_variant_stocks = 0;  // Set total_variant_stocks to null if status_id is 9
                }
                ...
                $updated = DB::table('product_variants')
                    ...
                    ->update([
                        ...
                        'stock' => $stocks ?? 0,  // Update the stocks
